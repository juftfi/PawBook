    ...
    <>
      ...
      <nav className="w-full max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4 text-sm">
          <Link to="https://pump.fun/coin/CQNs6nKFrYR4ouSV8MXzNAKdwXdcZmiiEV1E5GDWpump" target="_blank" className="text-white hover:text-white/80 transition-colors font-bold">
            $PAW
          </Link>
