    ...
    <>
      ...
      <nav className="w-full max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4 text-sm">
          <Link to="https://four.meme/en/token/0x90ab300c8b68b0eff7dc6bf9adb7650d24c14444" target="_blank" className="text-white hover:text-white/80 transition-colors font-bold">
            $PAW
          </Link>
